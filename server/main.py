"""wolfgang_rush — Indian Company Law Drafting MCPB.
...
FULL_ORCHESTRATION_SCRIPT = """# wolfgang_rush — INDIAN COMPANY-LAW FORUMS (NCLT / NCLAT / HIGH COURT COMPANY BENCH) DRAFTING · FULL ORCHESTRATION SCRIPT
