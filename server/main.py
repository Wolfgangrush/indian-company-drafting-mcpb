"""Wolfgang Rush — Indian Company Law Drafting MCPB.

Local-execution.

License: MIT
Source: https://github.com/Wolfgangrush/indian-company-drafting-mcpb
...
mcp = FastMCP("wolfgang-indian-company-drafting")
...
FULL_ORCHESTRATION_SCRIPT = """# WOLFGANG RUSH — INDIAN COMPANY-LAW FORUMS (NCLT / NCLAT / HIGH COURT COMPANY BENCH) DRAFTING · FULL ORCHESTRATION SCRIPT
